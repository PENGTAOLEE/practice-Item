...
<div class="swiper-container clearfix">
    <div class="swiper-wrapper-items">
		<!-- 参拍拍品 -->
        <div class="swiper-slide-item" v-if="isAuction || isFollow" v-for="(item,key) in dataList" :key="key">
           		...
           		<div class="items-ul clearfix">
                    <router-link :to="'/lotdetails/'+item.id" class="item-a">
	           				<div class="items-list-1">
	           					<img :src="baseUrl + item.thumb.url  + '?x-oss-process=image/resize,w_800'" />
	           					<p>{{ item.desc }}</p>
	           				</div>	
        ...
        <div class="swiper-slide-shop " v-if="isShop">
           	<div class="content-slide content-slide-border content-slide-none">
           		<div class="iteml-ul-attention cc"> 
           			<router-link :to="'/shops/'+item.user_id+'?type=2'" class="iteml-name" v-for="(item,key) in dataList" :key="key">
